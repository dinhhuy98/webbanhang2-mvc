      ...
      <div class="container  mt-5 pt-5">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-6 text-center">
            ...
            <h2 class="section-title mb-3 text-uppercase"><?php echo $data['category_name']; ?></h2>
            <h3 class="section-sub-title">Những sản phẩm <?php echo $data['category_name'];  ?> hot nhất</h3>
          </div>
        </div>
        <div class="row">
